                    ...
                    <form method="post" action="<?php echo asset('step1'); ?>">
                        <div class="row uniform 50%">
                            <div class="6u 12u(mobilep)">
                                <input required  type="text" name="fname" id="fname" value="<?php echo $order->fname?>" placeholder="First Name" />
                            </div>
                        ...
                        <div class="row uniform 50%">
                            <div class="12u">
                                <input required type="email" name="email" id="email" value="<?php echo $order->email?>" placeholder="Email" />
                            </div>
                            <div class="12u">
                                <input required type="text" name="company" id="company" value="<?php echo $order->company?>" placeholder="Company" />
                            </div>
                            <div class="12u">
                                <input required type="text" name="shop_url" id="shop_url" value="<?php echo $order->shop_url;?>" placeholder="Shop URL" />
                            </div>
